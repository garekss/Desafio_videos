...
// Se define la función reproducir que creará nuevas instancias de Reproductor para cada video
const reproducir = () => {
  ...
  // Creamos una nueva instancia de Reproductor para el video de música y reproducimos su contenido después de 1 segundos
  const musicaReproductor = new Reproductor(musicaUrl, "musica");
  musicaReproductor.reproducirContenido(10);

  //Creamos una nueva instancia de Reproductor para el video de películas y reproducimos su contenido después de 2 segundos
  const peliculasReproductor = new Reproductor(peliculasUrl, "peliculas");
  peliculasReproductor.reproducirContenido(20);

  // Creamos una nueva instancia de Reproductor para el video de series y reproducimos su contenido después de 3 segundos
